...
RowLayout {
    ...
    property var unitFractionNum: 1
    property var unitFractionDenum: 4
    ...
    ComboBox {
        ...
        onActivated: {
            ...
            unitText = model[currentIndex].sym;
            unitFractionNum = model[currentIndex].fnum;
            unitFractionDenum = model[currentIndex].fdenum;
        }
